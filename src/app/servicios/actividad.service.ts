...
export class ActividadService {
  ...
  private apiUrl = 'https://typo.api.adsocidm.com/api'; // URL base de tu API Laravel
  ...
  obtenerActividadesPorTipoMascota(access_token:any, id: number): Observable<Actividad[]> {
    return this.http.get<Actividad[]>(`${this.apiUrl}/auth/obtenerActividadesMascota/${id}`, this.obtenerOptions(access_token));
  }
